                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('starting_month', $options, (isset($experience['starting_month'])) ? $experience['starting_month'] : '', 'class="form-control" required');
                                ?>
                            </div>
                            <div class="col-md-3">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('starting_year', $options, (isset($experience['starting_year'])) ? $experience['starting_year'] : '', 'class="form-control" required');
                                ?>
                            </div>
                            <div class="col-md-3">
