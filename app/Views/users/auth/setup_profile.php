                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="date" name="dob" onchange="mydob()" id="dob" value="<?= (isset($data[0]['dob'])) ? $data[0]['dob'] : '' ?>" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label>Age * </label>
                                        <select name="age" class="form-control js-example-basic-single" required>
                                            <?php for ($i = 11; $i < 80; $i++) : ?>
                                                <?php if ($data[0]['age'] == $i) : ?>
