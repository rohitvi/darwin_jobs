...
<head>
    ...
    <title><?= get_g_setting_val('application_name') ?> | Reset Password</title>
...
<body class="hold-transition login-page">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="" id="sign_in" class="re_div" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-block sign-in">Change password</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
    ...
    <script type="text/javascript">
        $("#sign_in").on("submit", function() {
            ...
            $.ajax({
                url: "<?= base_url('admin/reset_password/' . $reset_code) ?>",
                method: "POST",
                data: fields,
