                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a>Applicant Listing</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        foreach ($applicants as $applicant) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a title="Shortlist" class="btn btn-xs btn-success pull-right" href="<?= base_url('admin/make_shortlist/' . $applicant['id'] . '/' . $applicant['job_id']); ?>">Shortlist Candidate</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
