          ...
          <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input name="phone_no" type="number" class="form-control" placeholder="Enter Phone Number" value="<?= $data[0]['phone_no'] ?>" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input name="postcode" type="number" class="form-control" placeholder="Enter Pincode" value="<?= $data[0]['postcode'] ?>" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
