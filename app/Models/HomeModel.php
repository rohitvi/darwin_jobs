...
class HomeModel extends Model
{
    ...
    {
        return $this->db->table('job_post')->select('job_post.*,companies.company_logo,companies.company_name,companies.description as cdescription,companies.website,companies.email')->join('companies', 'job_post.employer_id = companies.employer_id')->where('job_post.id =' . $id)->get()->getRowArray();
    }
